...
The second step is to turn these installation instructions into a Docker image, and tag this custom image using a Terminal command like this one:
...
```{r echo=FALSE, fig.cap="Scree plot from pyseer", out.width = '100%'}
